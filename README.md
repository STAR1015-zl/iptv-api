...
本仓库是 [Guovin/iptv-api](https://github.com/Guovin/iptv-api) 的 Fork 版本，由 [10000ge10000](https://github.com/10000ge10000) 维护。

**保留的定制化修改：**
- `config/user_config.ini` - 个人配置文件
...
本 Fork 同样遵循 AGPL-3.0 许可证，所有修改内容公开可见。
